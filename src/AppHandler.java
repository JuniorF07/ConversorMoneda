...
public class AppHandler extends Menu {
    ...
    public void firstOption() {
        while (this.getOption() == 1) {
            ...
            System.out.println("Ingresa la opcion de la moneda a convertir ");
            ...
            System.out.println("Ingresa la opcion de la moneda a la que quieres hacer el cambio: ");
            ...
            System.out.printf("Ingresa el monto que convertiras de '%s' a '%s': %n", currencyPairConversion.getBaseCode(), currencyPairConversion.getTargetCode());
            ...
            setContinueMessage("¿Realizará otra conversión de moneda?");
